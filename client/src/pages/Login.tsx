      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-4">
          <div className="mx-auto w-16 h-16 rounded-lg bg-primary/10 flex items-center justify-center">
            <svg width="56" height="24" viewBox="0 0 504 216" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="space-y-2">
            <CardTitle className="text-2xl font-semibold">XTRADERS Space</CardTitle>
